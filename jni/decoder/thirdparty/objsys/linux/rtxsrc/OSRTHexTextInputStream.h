 ...
 *****************************************************************************/
/**
 * @file OSRTHexTextInputStream.h
 * C++ hexadecimal text input stream filter class.
 */
#ifndef _OSRTHEXTEXTINPUTSTREAM_H_
#define _OSRTHEXTEXTINPUTSTREAM_H_
 ...
 */
class EXTRTCLASS OSRTHexTextInputStream : public OSRTInputStream {
 protected:
...
#endif /* _OSRTHEXTEXTINPUTSTREAM_H_ */
